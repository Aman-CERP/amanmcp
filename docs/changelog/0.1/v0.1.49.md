...
- Add roadmap execution framework for multi-session strategic improvement implementation
  ...
  - `.claude/checklists/roadmap-item.md`: Per-item workflow checklist
...
- Update roadmap v1.7: Integrated dogfooding - Add Part 12 (system-level TDD approach), link phases to dogfood baseline measurements, add RCA-010 queries as success criteria, update plan solidity 7.5/10 → 9.0/10
